...
var Hashids = (function () {
	...
	Hashids.prototype.encryptFromString = function(str) {

		var asciiArray = str.split('').map(function(item) {
			return item.charCodeAt(0);
		});

		return this.encrypt(asciiArray);
	...
	Hashids.prototype.decryptToString = function (hash) {

		var asciiArray = this.decrypt(hash);

		return asciiArray.map(function(c) {
